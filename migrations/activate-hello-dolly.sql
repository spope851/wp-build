...
SET @current_active_plugins = (SELECT option_value FROM wp_options WHERE option_name = 'active_plugins' LIMIT 1);

-- If no active plugins exist, create the option
INSERT INTO wp_options (option_name, option_value, autoload) 
SELECT 'active_plugins', 'a:1:{s:12:"hello-dolly/hello.php";s:0:"";}', 'yes'
WHERE NOT EXISTS (SELECT 1 FROM wp_options WHERE option_name = 'active_plugins');
